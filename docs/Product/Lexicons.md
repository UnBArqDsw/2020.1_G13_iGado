...
| **Impacto**       | Gerar [relatórios](/docs/Product/Lexicons?id=relatório) a respeito dos vários tipos de [manejo](/docs/Product/Lexicons?id=manejo)                               |
...
| **Impacto**       | Cálculo para saber o [Ganho de Massa Diário](/docs/Product/Lexicons?id=gmd) de um [bovino](/docs/Product/Lexicons?id=bovino) <br />[GMD](/docs/Product/Lexicons?id=gmd) é uma métrica para a geração de [relatórios](/docs/Product/Lexicons?id=relatório) |
...
| **Impacto**       | [RGD](/docs/Product/Lexicons?id=rgd) é uma métrica para a geração de [relatórios](/docs/Product/Lexicons?id=relatório)               |
